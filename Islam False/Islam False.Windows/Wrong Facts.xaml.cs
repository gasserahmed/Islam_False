...
namespace Islam_False
{
    ...
    public sealed partial class Wrong_Facts : Page
    {
        ...
        private void factLoad(int flag)
        {
            ...
            {
                Globals.fact = "The Prophet Muhammad was a pedophile";
            ...
            {
                Globals.fact = "Jihad means to fight for the sake of god";
            ...
            {
                Globals.fact = "Islam is intolerable to other religions";
